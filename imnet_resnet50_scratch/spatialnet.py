...
class SpatialNetUpscaled(nn.Module):
    ...
    def __init__(self, class_num=1000, block_func=OriginalSESpatialBlockFixed):
        super().__init__()
...
def spatialnet_original():
    return SpatialNetUpscaled(block_func=OriginalSESpatialBlockFixed)

def efficientnet_original():
    return SpatialNetUpscaled(block_func=OriginalSEFixed)
