...
if __name__ == "__main__":
    ...
    parser.add_argument('--imnet-path', default='/home/prakhar/FixRes/imagenet/', type=str, help='ImageNet dataset path')
    parser.add_argument('--shared-folder-path', default='/home/prakhar/FixRes/shared_folder', type=str, help='Shared Folder')
